...
void convert_message_lz(int message_number) { //Funktion zu Umwandeln der Auditing Nachrichten der Leitzentrale
  ...
  fehlercode = message[message_number][1] & B00001111;
  loknummer = (message[message_number][1] & B11110000)>>4;
  switch(fehlercode) {
  case 0:
  ...
  switch(message[message_number][2]) {
  case 0:
  ...
  switch(message[message_number][3]) {
  case 0:
    Serial.print("Fahrend");
    break;
  case 1:
...
void convert_message_bv(int message_number) { //Funktion zu Umwandeln der Auditing Nachrichten der Befehlsvalidierung
  ...
  switch(message[message_number][1]) {
  case 0:
    Serial.print("workBV ");
    break;
  case 1:
...
void convert_message_ev(int message_number) { //Funktion zu Umwandeln der Auditing Nachrichten der Ergebnisvalidierung
  ...
  case 6:
    ...
    Serial.print(message[message_number][3],BIN);
    Serial.print(message[message_number][4],BIN);
    Serial.print(message[message_number][5],BIN);
    break;
  case 7:
